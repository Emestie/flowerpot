 ...
 */
const ALLOWED_ORIGINS_AND_PERMISSIONS = new Map(import.meta.env.DEV && import.meta.env.VITE_DEV_SERVER_URL
 ...
 * >
 */
const ALLOWED_EXTERNAL_ORIGINS = new Set(["https://github.com", "https://mysweetbot.netlify.app"]);
