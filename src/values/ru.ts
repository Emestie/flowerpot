...
const ru: LocalizedStrings = {
    ...
    ddShowNotifLabel: "Уведомления о рабочих элементах: ",
    ...
    prNotifications: "Уведомления о запросах на вытягивание: ",
    sectionNotifications: "Уведомления",
    settingsNotificationsHeader: "Уведомления",
