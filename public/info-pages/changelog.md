...
-   в отображении пулл реквестов добавлена новая информация: тэги, названия участвующих веток, статус возможности мержа, а так же список ревьюверов с отметками об обязательности и статусе ревью
